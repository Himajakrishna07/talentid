(window.tawkJsonp = window.tawkJsonp || []).push([["chunk-71978bb6"], {
    "1e0f": function(t, i, e) {
        "use strict";
        (function(t) {
            var o = e("2f62")
            ...
            i.a = {
                ...
                data: function() {
                    return {
                        cssLink: "".concat("https://embed.tawk.to/_s/v4/app/67354992019", "/css/min-widget.css"),
                        isLoaded: !1,
                        clickEvent: "touchend",
                        resizeWidth: 0,
                ...
                computed: l(l({}, Object(o.c)({
                    ...
                    buttonStyles: function() {
                        var t = {};
                        return this.isRoundWidget || (this.mobileBrowserName ? (t.borderRadius = "3px",
                        t.width = this.resizeWidth ? "".concat(this.resizeWidth, "px") : "".concat(this.minMobile.width, "px"),
                        t.height = "".concat(this.minMobile.height, "px"),
                        t.padding = "0 8px") : (t.borderRadius = "".concat(this.minDesktop.borderRadiusTop, "px ").concat(this.minDesktop.borderRadiusTop, "px\n\t\t\t\t\t").concat(this.minDesktop.borderRadiusBottom, "px ").concat(this.minDesktop.borderRadiusBottom, "px"),
                        t.width = "".concat(this.minDesktop.width, "px"),
                        t.height = "".concat(this.minDesktop.height, "px"),
                        t.padding = "0 15px")),
                        this.isBottom || this.isCenter ? t.bottom = "0" : t.top = "0",
                    ...
                    styleObject: function() {
                        var t, i, e = this.mobileBrowserName ? this.minMobile : this.minDesktop, o = {
                        ...
                        this.mobileBrowserName ? this.isMobileLandscape ? "safari" === this.mobileBrowserName ? (t = this.xOffsetMobile,
                        i = this.yOffsetMobile) : (t = this.xOffsetMobile / 1.7,
                        i = this.yOffsetMobile / 1.7) : (t = this.xOffsetMobile,
                        i = this.yOffsetMobile) : (t = this.xOffset,
                        i = this.yOffset);
                        var n = t * this.zoomRatio;
                        if (this.isRight ? o["right:"] = "".concat(n, "px !important;") : o["left:"] = "".concat(n, "px !important;"),
                        this.isCenter) {
                            if (o["top:"] = "calc((50% - ".concat(.5 * e.height, "px) + ").concat(i, "px) !important;"),
                            !this.isRoundWidget) {
                                var a = .5 * e.height - .5 * e.width + t
                                  , s = "49% !important"
                                  , r = "rotate(".concat(this.isRight ? "-90deg" : "90deg", ") !important");
                                this.mobileBrowserName ? (s = "0 0 !important",
                                this.isRight ? (o["left:"] = "calc(100% - ".concat(this.iFrameHeight, " - ").concat(this.xOffsetMobile * this.zoomRatio, "px) !important;"),
                                r = "rotate(-90deg) translateX(-50%) !important") : (o["right:"] = "85% !important;",
                                o["left:"] = "calc(".concat(this.iFrameHeight, " + ").concat(this.xOffsetMobile * this.zoomRatio, "px) !important;"),
                                r = "rotate(90deg) translateX(-50%) !important")) : this.isRight ? o["right:"] = "".concat(a, "px !important;") : o["left:"] = "".concat(a, "px !important;"),
                            ...
                            this.isBottom ? o["bottom:"] = "".concat(i * this.zoomRatio, "px !important;") : o["top:"] = "".concat(i * this.zoomRatio, "px !important;");
                        ...
                        ), 250) : o["display:"] = "none !important;",
                        l(l({}, this.genericStyles), o)
                    },
                    badgePosition: function() {
                        var t, i, e = this.mobileBrowserName ? this.minMobile : this.minDesktop, o = {};
                        return this.mobileBrowserName && this.resizeWidth && (e.width = this.resizeWidth + 5),
                        this.isRoundWidget ? (t = "".concat(e.width - 20, "px"),
                        i = "".concat(e.height - 20, "px")) : (t = "".concat(e.width - 16, "px"),
                        i = "".concat(e.height - 16, "px")),
                        this.isBottom || this.isCenter ? (o.left = t,
                        o.bottom = i,
                        o.right = "auto",
                        o.top = "auto") : (o.left = t,
                        o.top = "0px",
                ...
                methods: l(l({}, Object(o.b)({
                    ...
                    scaleContent: function() {
                        var t, i = this.isRTL ? "right" : "left", e = "scale(".concat(this.zoomRatio, ")");
                        t = this.isBottom || this.isCenter ? "bottom" : "top",
                        this.mobileBrowserName && this.isMobileLandscape && ("safari" !== this.mobileBrowserName || "iphone" !== this.os.identity && "mac" !== this.os.identity ? "safari" === this.mobileBrowserName || "iphone" !== this.os.identity && "mac" !== this.os.identity || (e = "scale(".concat(this.zoomRatio / 1.7, ")")) : e = "scale(".concat(1.2 * this.zoomRatio, ")"));
                    ...
                    contentChange: function() {
                        ...
                        this.mobileBrowserName && !this.isRoundWidget && setTimeout((function() {
                            if (t.$refs && t.$refs["min-content"] && t.$refs["min-content"].$refs) {
                                ...
                                t.resizeWidth > screen.width && (t.resizeWidth = screen.width - 2 * t.xOffsetMobile,
        ...
        var c = {
            ...
            computed: s(s({}, Object(o.c)({
                ...
                minimizeText: function() {
                    if (this.mobileBrowserName)
                        return "offline" === this.pageStatus ? this.$i18n("form", "message") : this.$i18n("chat", "chat_text");
