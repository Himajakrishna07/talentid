(window.tawkJsonp = window.tawkJsonp || []).push([["chunk-f1565420"], {
    "0bdc": function(t, e, i) {
        "use strict";
        i.r(e);
        var o = i("9287").a
        ...
        (function(t) {
            ...
            e.a = {
                ...
                data: function() {
                    return {
                        isHidden: "hidden",
                        cssLink: "".concat("https://embed.tawk.to/_s/v4/app/67354992019", "/css/bubble-widget.css"),
                        closeIconWidth: 16,
                ...
                computed: l(l({}, Object(s.c)({
                    ...
                    textCloseButton: function() {
                        ...
                        return this.isRTL ? t.left = "2px" : t.right = "2px",
                        this.isBottom || this.isCenter ? t.top = "0" : t.bottom = "0",
                        t
                    },
                    styleObject: function() {
                        ...
                        return "max" === this.chatWindowState || "offline" === this.pageStatus || this.chatBubbleClosed || this.messagePreviewIsVisible ? t["display:"] = "none !important;" : t["display:"] = "block !important;",
                    ...
                    imageUrl: function() {
                        ...
                        if ("gallery" === e.image.type) {
                            ...
                            this.isCenter ? i += this.isRight ? "-cr" : "-cl" : this.isBottom ? i += this.isRight ? "-br" : "-bl" : i += this.isRight ? "-tr" : "-tl",
                            t = "".concat("https://embed.tawk.to/_s/v4/assets", "/images/attention-grabbers/").concat(i).concat(o ? ".png" : ".svg")
                        } else
                            t = "".concat("https://tawk.link", "/").concat(e.image.content);
                        return t
                    },
                    offsets: function() {
                        var t = 0
                        ...
                        if (this.isCenter)
                            if ("text" === this.bubble.type)
                                ...
                                e -= 10) : (i = 90,
                                this.isRoundWidget || (e = this.minDesktop.width + e - 146),
                                e += 10),
                                ...
                                o && (e += this.yOffset,
                                t += this.xOffset),
                                0 !== this.bubbleRotate && (o ? t -= 3 : t += 2)
                            }
                        else
                            "text" === this.bubble.type ? (e = this.minDesktop.height + this.yOffset + 2,
                            t = this.xOffset) : "image" === this.bubble.type && "gallery" === this.bubble.config.image.type ? (e = this.yOffset + this.bubbleYOffset,
                            t = this.xOffset + this.bubbleXOffset,
                            i = this.bubbleRotate) : (e = this.bubbleYOffset,
                            t = this.bubbleXOffset,
                            i = this.bubbleRotate);
                        return {
                            xOffset: t,
                ...
                methods: l(l({}, Object(s.b)({
                    ...
                    calculatePosition: function() {
                        var t, e, i = "image" === this.bubble.type && "gallery" === this.bubble.config.image.type, o = this.offsets, s = "text" === this.bubble.type ? 85 : this.bubble.config.height + this.closeIconWidth, n = "text" === this.bubble.type ? 146 : this.bubble.config.width, a = {}, r = "0;", b = "50% !important;";
                        if (this.isCenter) {
                            var l, c = o.yOffset, h = -.5 * s;
                            r = "49%;",
                            0 === o.rotate ? (i ? (l = 0,
                            b = "calc(50% - ".concat(.5 * this.bubble.config.height + 13 - c, "px) !important;"),
                            t = "0") : l = .5 * (this.minDesktop.width - s),
                            e = "".concat(o.xOffset, "px !important;")) : i ? (l = 0,
                            c = 0 === this.yOffset ? 0 : o.yOffset,
                            e = "".concat(-1 * (.5 * (n - s) - o.yOffset), "px !important;")) : (l = .5 * (this.minDesktop.width - n),
                            e = "".concat(-1 * (.5 * (n - s) - o.xOffset), "px !important;")),
                            this.isRight ? (a["right:"] = e,
                            a["left:"] = "auto !important;") : (a["right:"] = "auto !important;",
                            a["left:"] = e),
                            a["top:"] = b,
                            ...
                            t = "0",
                            this.isBottom ? (a["bottom:"] = o.yOffset + "px !important;",
                            a["top:"] = "auto !important;") : (a["bottom:"] = "auto !important;",
                            a["top:"] = o.yOffset + "px !important;"),
                            this.isRight ? (a["right:"] = o.xOffset + "px !important;",
                            a["left:"] = "auto !important;") : (a["right:"] = "auto !important;",
                            a["left:"] = o.xOffset + "px !important;");
                    ...
                    loaded: function() {
                        if ("text" === this.bubble.type) {
                            ...
                            y.fillStyle = w,
                            this.isCenter || this.isBottom ? (e = p = 6,
                            i = p + m - 3,
                            o = 55,
                            s = 79,
                            n = !0,
                            ...
                            o = 81,
                            f = !n,
                            this.isBottom || this.isCenter ? (f = !n,
                            a.s2 = .6,
                            a.a2 = 1.85) : (f = n,
                            a.s2 = .2,
                            a.a2 = 1.45)) : (b = (r = 2) + d - 2,
                            ...
                            y.lineTo(68, p),
                            y.lineTo(r + d - 8, p),
                            y.quadraticCurveTo(r + d, p, r + d, p + 8),
                            y.lineTo(r + d, p + m - 8),
                            y.quadraticCurveTo(r + d, p + m, r + d - 8, p + m),
                            y.lineTo(r + 8, p + m),
                            y.quadraticCurveTo(r, p + m, r, p + m - 8),
                            y.lineTo(r, p + 8),
                            y.quadraticCurveTo(r, p, r + 8, p),
                            y.strokeStyle = k,
                            y.lineWidth = 2,
                            y.stroke(),
                            y.closePath(),
                            y.fill(),
                            y.beginPath(),
                            y.arc(68, i, 10, Math.PI * a.s1, Math.PI * a.a1, n),
                            y.strokeStyle = k,
                            y.lineWidth = 2,
                            y.stroke(),
                            y.fill(),
                            this.isRoundWidget && (this.isBottom || this.isCenter || this.isRight ? (this.isBottom && this.isRight || this.isCenter && this.isRight) && (o += 30) : o -= 30),
                            y.beginPath(),
                            y.arc(o, s, 5, 0, 2 * Math.PI, !1),
                            y.strokeStyle = k,
                            y.lineWidth = 2,
                            y.stroke(),
                            y.closePath(),
                            y.fill(),
                            y.beginPath(),
                            y.arc(b, e + 5, 10, Math.PI * a.s2, Math.PI * a.a2, f),
                            y.strokeStyle = k,
                            y.lineWidth = 2,
                            y.stroke(),
                            y.closePath(),
